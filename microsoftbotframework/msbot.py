...
# Generate ssl key to serve https:
# from werkzeug.serving import make_ssl_devcert
# make_ssl_devcert('C:/Users/rousselotvigier.a/Desktop/testwithsdk/server.key',host='localhost')
# from OpenSSL import SSL
# context= SSL.Context(SSL.SSLv23_METHOD)
# context.use_privatekey_file('C:/Users/rousselotvigier.a/Desktop/testwithsdk/server.key')
# context.use_certificate_file('C:/Users/rousselotvigier.a/Desktop/testwithsdk/server.crt')
context=('C:/Users/rousselotvigier.a/Desktop/testwithsdk/server.crt','C:/Users/rousselotvigier.a/Desktop/testwithsdk/server.key')
...
class MsBot(Flask):
    ...
    def run(self, host=None, port=None, debug=None, **options):
        ...
        super(MsBot,self).run(host, port, debug,ssl_context=context, **options)
